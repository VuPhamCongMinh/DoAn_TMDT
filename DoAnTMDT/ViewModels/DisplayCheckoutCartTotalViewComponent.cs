...
{
    public class DisplayCheckoutCartTotalViewComponent : ViewComponent
    {
        private readonly CookieServices _cookieServices;
        private readonly DoAnTMDT_Entities _context;
        public DisplayCheckoutCartTotalViewComponent(CookieServices cookieServices, DoAnTMDT_Entities context)
        {
